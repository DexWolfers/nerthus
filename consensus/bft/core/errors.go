...
var (
	...
	// errFutureUnitMessage is returned when current number is less than the number of
	// received message
	errFutureUnitMessage = errors.New("future unit message")
	// errWaitNewRound is returned when consensus wait for new round
	errWaitNewRound = errors.New("consensus wait to new round")
)
