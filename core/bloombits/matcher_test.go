...
func TestMatcherWildcards(t *testing.T) {
	matcher := NewMatcher(testSectionSize, [][][]byte{
		{common.Address{}.Bytes(), common.BytesToAddress([]byte{0x1}).Bytes()}, // Default address is not a wildcard
...
// bitset matching https://gitee.com/nerthus/nerthus/issues/15309.
