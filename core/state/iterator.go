...
func (it *NodeIterator) step() error {
	...
	dataTrie, err := it.state.db.OpenStorageTrie(it.state.dataPrefix, common.BytesToHash(it.stateIt.LeafKey()), account.Root)
	if err != nil {
		return err
	}
	...
	if !bytes.Equal(account.CodeHash, emptyCodeHash) {
		...
		it.code, err = it.state.db.ContractCode(it.state.dataPrefix, addrHash, common.BytesToHash(account.CodeHash))
		if err != nil {
