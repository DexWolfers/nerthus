...
func (mux *TypeMux) subscribe(sub *TypeMuxSubscription, types ...interface{}) {
	mux.mutex.Lock()
...
func (mux *TypeMux) Subscribe(types ...interface{}) *TypeMuxSubscription {
	sub := newsub(mux, 0)
	mux.subscribe(sub, types...)
	return sub
}

func (mux *TypeMux) SubscribeWithSize(typ interface{}, size int) *TypeMuxSubscription {
	sub := newsub(mux, size)
	mux.subscribe(sub, typ)
	return sub
}
...
func newsub(mux *TypeMux, size int) *TypeMuxSubscription {
	c := make(chan *TypeMuxEvent, size)
