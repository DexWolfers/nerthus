...
func TestConvertBits(t *testing.T) {
	...
	data := []byte{23, 3, 106, 127, 120, 61, 70, 166, 223, 209, 63, 74, 136, 138, 24, 235, 59, 57, 200, 145}
	...
	reconvered, err := bech32.ConvertBits(converted, 5, 8, true)
	if err != nil {
		t.Fatal(err)
	}
	if bytes.Compare(data, reconvered) != 0 {
		t.Logf("not equal:\ndata:%v \n got:%v", data, reconvered)
	}
}
