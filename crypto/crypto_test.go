...
var testAddrHex = "nts1zupk5lmc84r2dh738a9g3zscavannjy32kr2h7"
...
func TestSign(t *testing.T) {
	...
	addr := common.ForceDecodeAddress(testAddrHex)
	...
	recoveredAddr := ForceParsePubKeyToAddress(*pubKey)
	...
	recoveredAddr2 := ForceParsePubKeyToAddress(*recoveredPub2)
...
func TestLoadECDSAFile(t *testing.T) {
	...
	checkKey := func(k *ecdsa.PrivateKey) {
		checkAddr(t, ForceParsePubKeyToAddress(k.PublicKey), common.ForceDecodeAddress(testAddrHex))
