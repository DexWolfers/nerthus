...
func makeReceipt(addr common.Address) *types.Receipt {
	receipt := types.NewReceipt(types.ActionTransferReceipt, common.StringToHash("root"), false, big.NewInt(0))
...
func BenchmarkFilters(b *testing.B) {
	...
	//
	//var (
	//	db, _      = ntsdb.NewLDBDatabase(dir, 0, 0)
	...
	//chain := core.GenerateChain(params.TestChainConfig, genesis, db, 100010, func(i int, gen *core.UnitGen) {
	//	switch i {
	//	case 2403:
	...
	//	if err := core.WriteCanonicalHash(db, block.Hash(), block.Number()); err != nil {
